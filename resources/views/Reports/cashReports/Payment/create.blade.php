...
<ul class="breadcome-menu">
    ...
    <li>
        <span class="bread-blod"> {{ __('titles.cash_payments_reports') }} </span>
    </li>
</ul>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="mg-b-15">
                    ...
                    <a href="{{url(Auth::user()->role_id == 100 || Auth::user()->role_id == 101 || Auth::user()->role_id == 110 ? '/' : '/Company')}}" class="btn btn-primary waves-effect waves-light">{{ __('titles.cancel') }}</a>
                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd dir-rtl">
                                <h4>{{ __('titles.cash_payments_reports') }}</h4>
                            </div>
                        </div>

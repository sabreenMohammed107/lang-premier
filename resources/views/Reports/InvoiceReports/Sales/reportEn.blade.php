...
<div class="rep_name">
    <span >{{ __('titles.invoice_no') }}: {{$Invoice->invoice_no}}</span>
</div><br><br><br>
<div style="text-align: right;font-size:12px;background-color: #eee;padding:10px;direction:rtl; width:40%;">
    <span >{{ __('titles.name') }} / {{$Invoice->person_name}}</span><br>
    <span >{{ __('titles.date') }}: {{date('d-m-Y', strtotime($Invoice->inv_date))}}</span>
</div>
<div class="right">
    <div  class="company">
        <span>

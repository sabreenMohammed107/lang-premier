                                        ...
                                        <div class="row row-ltr">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
													<div class="form-group">
														...
														<input name="guided_item_code" value="{{$row->guided_item_code}}" type="text" class="form-control" placeholder="{{ __('titles.code') }}">
													</div>
													<div class="form-group">
														<label class="">{{ __('titles.name') }}</label>
														<input name="guided_item_name" value="{{$row->guided_item_name}}" type="text" class="form-control" placeholder="{{ __('titles.name') }}">
													</div>
													<div class="form-group">

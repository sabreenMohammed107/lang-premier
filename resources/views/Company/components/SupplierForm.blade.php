...
@if(str_replace('_', '-', app()->getLocale())=='ar')
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap drp-lst dir-ltr">
                        <h4 >{{$title ?? ''}}</h4>
                    </div>
                                    ...
                                    <div id="dropzone1" class="pro-ad addcoursepro">
                                            <div class="row ">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                                                    ...
                                                    <input tabindex="15" name="contact_person_mobile" {{$disabled ?? ''}} value="{{$contact_person_mobile ?? ''}}" type="text" class="form-control" placeholder="{{ __('titles.contact_person_mobile') }}">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    {{-- <div class="form-group">
                                                        <label class="fax">{{ __('titles.fax') }}</label>
                                                    <input name="fax" {{$disabled ?? ''}} value="{{$fax ?? ''}}" type="text" class="form-control" placeholder="{{ __('titles.fax') }}">
                                                    </div> --}}
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                                                    <div class="form-group">
                                                        <label class="">{{ __('titles.phone') }} 1</label>
                                                    <input name="phone1" tabindex="6" {{$disabled ?? ''}} value="{{$phone1 ?? ''}}" type="text" class="form-control" placeholder="{{ __('titles.mobile') }}">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <input name="open_balance" {{$disabled ?? ''}} {{$open ?? ''}} value="{{$openBalance ?? ''}}" id="email" type="text" class="form-control" placeholder=" {{ __('titles.open_blance_amount') }}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="">{{ __('titles.open_balance_date') }}</label>
                                                    <input name="balance_start_date" {{$disabled ?? ''}} {{$open ?? ''}} value="{{$openBalanceDate ?? ''}}" id="email" type="date" class="form-control" placeholder="{{ __('titles.open_balance_date') }}">
                                                    </div>
                                                    <div class="form-group">
